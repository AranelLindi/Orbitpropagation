...
struct Calendar {
    ...
    template <typename T> static inline double getfrac(double decimal); // Nachkommastellen extrahieren
    static inline int getint(double decimal); // Ganzzahlenteil zurückgeben
